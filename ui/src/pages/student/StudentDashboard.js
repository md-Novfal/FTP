...
function StudentDashboard() {
  ...
  return (
    <Box>
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" fontWeight={800} sx={{ color: 'primary.main' }}>My Dashboard</Typography>
        <Typography variant="body2" color="text.secondary">Track your applications and profile progress</Typography>
      </Box>
        ...
        <Table size="small">
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={5} align="center">No applications yet. Start your journey now!</TableCell>
              </TableRow>
