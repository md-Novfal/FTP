        ...
        <Box
          sx={{
            ...
            backgroundColor: `rgba(${
              color === '#1a73e8' ? '59, 130, 246' : color === '#34a853' ? '5, 150, 105' : color === '#fbbc04' ? '245, 158, 11' : '239, 68, 68'
            }, 0.1)`,
            borderRadius: 2,
          }}
        >
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
                <TableCell sx={{ fontWeight: 700, color: 'primary.main' }}>Student</TableCell>
            ...
            <TableBody>
              {loading ? (
                ...
                displayedApps.map((app) => (
                  ...
                  >
                    <TableCell sx={{ fontWeight: 500 }}>{app.userId?.username ?? '—'}</TableCell>
